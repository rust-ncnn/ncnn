...
void print_fp32_vec(float* p, float* q, int m) {
//    for (int i = 0; i < m; ++i) {
//        fprintf(stdout, "%f %f\t", p[i], q[i]);
//    }
//    fprintf(stdout, "\n");
}
...
void int8kernel_m1_new(void* dst, int8_t* sa, int8_t* sb, int m, int k, int n, int ldc, float* scales, float* bias) {
    void *pc = dst;
    int8_t *pa = sa;
    int8_t *pb = sb;
...
void int8kernel_m2_new(void* dst, int8_t* sa, int8_t* sb, int m, int k, int n, int ldc, float* scales, float* bias) {
    void *pc0, *pc1;
    if (scales == nullptr) {
        pc0 = (int32_t*)dst;
        pc1 = ((int32_t*)pc0) + ldc;
...
void int8kernel_m4_new(void* dst, int8_t* sa, int8_t* sb, int m, int k, int n, int ldc, float* scales, float* bias) {
...
void int8kernel(void* dst, int8_t* sa, int8_t* sb, int m, int k, int n, int ld, float* scales, float* bias) {
    int8_t* pa = sa;
    int8_t* pb = sb;
    const int nn = (m >> 2) << 2;
    if (scales == nullptr) {
        ...
        for (int i = 0; i < nn; i += 4) {
            int8kernel_m4_new((void*)(pc + i * n), pa + i * k, pb, m, k, n, n, nullptr, nullptr);
        }
        ...
        {
            case 3:
                int8kernel_m2_new((void*)pc, pa, pb, m, k, n, n, nullptr, nullptr);
                pc += 2 * n;
                pa += 2 * k;
                int8kernel_m1_new((void*)pc, pa, pb, m, k, n, n, nullptr, nullptr);
                break;
            case 2:
                int8kernel_m2_new((void*)pc, pa, pb, m, k, n, n, nullptr, nullptr);
                break;
        ...
        for (int i = 0; i < nn; i += 4) {
            int8kernel_m4_new((void*)(pc + i * n), pa + i * k, pb, m, k, n, n, scales + i, (bias==nullptr)? nullptr: bias+i);
        }
        ...
        {
            case 3:
                int8kernel_m2_new((void*)pc, pa, pb, m, k, n, n, scales, bias);
                pc += 2 * n;
                pa += 2 * k;
                scales += 2;
                bias = (bias == nullptr)? nullptr: bias + 2;
                int8kernel_m1_new((void*)pc, pa, pb, m, k, n, n, scales, bias);
                break;
            case 2:
                int8kernel_m2_new((void*)pc, pa, pb, m, k, n, n, scales, bias);
                break;
...
//    fprintf(stdout, "3. compute_baseline finish\n");
    ...
    fprintf(stdout, "\n---- test m: %d, k: %d, n: %d\n", m, k, n);
    int8kernel((void*)sc, sa, sb, m, k, n, n, nullptr, nullptr);
