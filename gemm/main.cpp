...
//          "=r"(scales), // %6
//          "=r"(bias)    // %7
void int8kernel_m4_new(int32_t* dst, int8_t* sa, const int8_t* sb, int m, int k, int n, int ldc, float* scales, const float* bias) {
    int32_t *pc = dst;
    int8_t *pa = sa;
    ...
    asm volatile (
        ...
        "        cmp %7, #0           \n"
        "        beq m4_loopnd4_end_requant   // skip add %7\n"
        ...
        "        cmp %7, #0                 \n"
        "        beq m4_loopnd1_end_requant   // skip add %7\n"
    ...
    // 1281 - 427 = 854
        ...
        : "0"(pa),
          ...
          "6"(scales),
          "7"(bias)
        : "cc", "memory", "x8", "x9", "x10", "x11", "x12", "x13", "x14", "x15", "x16", "x17", "x18", "x19", "x20", "x21", "x22", "x23", "x24", "x25","v0", "v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10", "v11", "v12", "v13", "v14", "v15", "v16", "v17", "v18", "v19", "v20", "v21", "v22", "v23", "v24", "v25", "v26", "v27", "v28", "v29", "v30", "v31"
    );
}

void int8kernel_m2_new(int32_t* dst, int8_t* sa, const int8_t* sb, int m, int k, int n, int ldc, float* scales, const float* bias) {
    auto pa = sa;
    auto pc = dst;
    ...
    asm volatile(
        ...
        ".macro M2_DECOMPOSE_K  \n"
        "    mov x3, %x3        \n"
        "    lsr x9, x3, 3  // kd8_ori = k / 8, means loopk\n"
        "    lsr x22, x9, 1     \n"
        "    lsl x13, x22, 1    \n"
        "    sub x13, x9, x13   \n"
        ...
        "        cmp %7, #0\n"
        "        beq m2_loopnd4_end_requant   // skip add %7\n"
        ...
        "        cmp %7, #0                 \n"
        "        beq m2_loopnd2_end_requant   // skip add %7\n"
        ...
        "        cmp %7, #0 \n"
        "        beq m2_loopnd1_end_requant   // skip add %7\n"
        ...
        : "0"(pa),
          ...
          "6"(scales),
          "7"(bias)
        : "cc", "memory", "x8", "x9", "x10", "x11", "x12", "x13", "x14", "x15", "x16", "x17", "x18", "x19", "x20", "x21", "x22", "x23", "x24", "v0", "v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10", "v11", "v12", "v13", "v14", "v15", "v16", "v17", "v18", "v19", "v20", "v21", "v22", "v23", "v24", "v25", "v26", "v27", "v28", "v29", "v30", "v31"
        ); 
    return;   
}

void int8kernel_m1_new(int32_t* dst, int8_t* sa, const int8_t* sb, int m, int k, int n, int ldc, float* scales, const float* bias) {
    asm volatile(
        ".macro M1_DECOMPOSE_K  \n"
        "    mov x3, %x3        \n"
        "    lsr x9, x3, 3      \n"
        "    lsr x24, x9, 1     \n"
        "    lsl x15, x24, 1    \n"
        ...
        "        cmp %7, #0\n"
        "        beq m1_loopnd4_end_requant   // skip add %7\n"
        ...
        "        cmp %7, #0                 \n"
        "        beq m1_loopnd2_end_requant   // skip add %7\n"
        ...
        "        cmp %7, #0                                 \n"
        "        beq m1_loopnd1_end_requant   // skip add %7   \n"
        ...
        : "0"(sa),
          ...
          "6"(scales),
          "7"(bias)
        : "cc", "memory", "x8", "x9", "x14", "x15", "x16", "x17", "x18", "x19", "x20", "x21", "x22", "x23", "x24", "w25","v0", "v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10", "v11", "v12", "v13", "v14", "v15", "v16", "v17", "v18", "v19", "v20", "v21", "v22", "v23", "v24", "v25", "v26", "v27", "v28", "v29", "v30", "v31"
    );
}
...
void int8kernel(int32_t* dst, int8_t* sa, int8_t* sb, int m, int k, int n, int ld, float* scales, float* bias) {
    ...
    for (int i = 0; i < nn; i += 4) {
        ...
        int8kernel_m4_new(pc + i * n, pa + i * k, pb, m, k, n, n, NULL, NULL);
    ...
    {
        case 3:
            int8kernel_m2_new(pc, pa, pb, m, k, n, n, NULL, NULL);
            pc += 2 * n;
            pa += 2 * k;
            int8kernel_m1_new(pc, pa, pb, m, k, n, n, NULL, NULL);
            break;
        case 2:
            int8kernel_m2_new(pc, pa, pb, m, k, n, n, NULL, NULL);
            break;
...
int test(int m, int k, int n, int ldc) {
    int8_t* a = (int8_t*)malloc(2*m*k);    
    int8_t* sa = (int8_t*)malloc(2*m*k);    
    int8_t* sa_as = (int8_t*)malloc(2*m*k);    

    int8_t* b = (int8_t*)malloc(2*k*n);
    int8_t* sb = (int8_t*)malloc(2*k*n);

    int32_t* c = (int32_t*)malloc(2*m*n*sizeof(int32_t));
    int32_t* sc = (int32_t*)malloc(2*m*n*sizeof(int32_t));
    ...
    fprintf(stdout, "1. reorder_a finish\n");
    ...
    fprintf(stdout, "2. reorder_b finish\n");

    int8kernel(sc, sa, sb, m, k, n, n, NULL, NULL);
    fprintf(stdout, "4. compute_new finish\n");
    ...
    fprintf(stdout, "5. check result finish\n");
